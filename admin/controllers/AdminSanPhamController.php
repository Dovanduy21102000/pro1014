    ...
    public function postAddSanPham()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($errors)) {
                ...
                header('Location: ' . BASE_URL_ADMIN . 'san-pham');
                exit();
            } else {
                //trả về form và lỗi
                // Đặt chỉ thị xóa session sau khi hiển thị form
                $_SESSION['flash'] = true;
                header('Location: ' . BASE_URL_ADMIN . 'form-them-san-pham');
                exit();
            }
        }
        // var_dump($_POST);
    ...
    public function postEditSanPham()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if (empty($errors)) {
                ...
                // Đặt chỉ thị xóa session sau khi hiển thị form
                $_SESSION['flash'] = true;
                header('Location: ' . BASE_URL_ADMIN . 'form-sua-san-pham&id_san_pham=' . $san_pham_id);
                exit();
            }
        }
        // var_dump($_POST);
        ...
        if ($binhLuan) {
            ...
            if ($status) {
                if ($name_view == 'detail_khach') {
                    header("Location: " . BASE_URL_ADMIN . 'chi-tiet-khach-hang&id_khach_hang=' . $binhLuan['tai_khoan_id']);
                } else {
                    header("Location: " . BASE_URL_ADMIN . 'chi-tiet-san-pham&id_san_pham=' . $binhLuan['san_pham_id']);
                }
            }
        }
    }
